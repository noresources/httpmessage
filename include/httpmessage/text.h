...
/**
 * @ingroup text
 * @brief Assign text to the string view
 *
...
/**
 * @ingroup text
 * @brief Compare two string view, ignoring case.
 *
 * @param a First string view
 * @param b Second string view
 *
 * @return < 0 if (string < text), 0 if (string == text) and > 0 if (string > text)
 */
HMAPI int httpmessage_stringview_caseless_compare(
