...
TARGET = $(TARGETDIR)/test-preprocessor.exe
OBJDIR = ../../../dist/obj/Debug/test-preprocessor
...
TARGET = $(TARGETDIR)/test-preprocessor.exe
OBJDIR = ../../../dist/obj/Release/test-preprocessor
...
GENERATED += $(OBJDIR)/preprocessor.o
OBJECTS += $(OBJDIR)/preprocessor.o
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking test-preprocessor
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test-preprocessor
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
...
$(OBJDIR)/preprocessor.o: ../../../tests/preprocessor.c
	@echo $(notdir $<)
